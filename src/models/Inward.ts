...
const inwardSchema = new Schema(
  {
    ...
    weightUnit: { type: String, default: 'KG', trim: true, uppercase: true },
    challanNumber: { type: String, default: '', trim: true, uppercase: true },
    ...
    pillarId: { type: Schema.Types.ObjectId, ref: 'Pillar', default: null },
...
export type Inward = InferSchemaType<typeof inwardSchema> & { _id: mongoose.Types.ObjectId };
