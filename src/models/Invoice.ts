...
const invoiceSchema = new Schema(
  {
    ...
    sourceIds: { type: [{ type: Schema.Types.ObjectId }], default: [] },
    inwardId: { type: Schema.Types.ObjectId, ref: 'Inward', default: null },
    outwardId: { type: Schema.Types.ObjectId, ref: 'Outward', default: null },
    inwardIds: { type: [{ type: Schema.Types.ObjectId, ref: 'Inward' }], default: [] },
    outwardIds: { type: [{ type: Schema.Types.ObjectId, ref: 'Outward' }], default: [] },
