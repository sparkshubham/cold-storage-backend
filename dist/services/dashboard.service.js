...
export async function getSuperAdminDashboard() {
    ...
    const [totalCompanies, activeCompanies, suspendedCompanies, trialCompanies, totalUsers, totalCustomers, monthlyRevenueAgg, outstandingAgg, expiringSubscriptions, growth, occupiedAgg, capacityAgg,] = await Promise.all([
