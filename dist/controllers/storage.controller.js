...
export const listChambers = asyncHandler(async (req, res) => {
...
export const createChamber = asyncHandler(async (req, res) => {
    const doc = await storageService.createChamber(requireTenantId(req), req.body, getAuthUser(req));
    return created(res, doc);
});
export const updateChamber = asyncHandler(async (req, res) => {
...
export const removeChamber = asyncHandler(async (req, res) => {
...
export const listRacks = asyncHandler(async (req, res) => {
    const pagination = getPagination(req);
...
export const updateRack = asyncHandler(async (req, res) => {
...
export const removeRack = asyncHandler(async (req, res) => {
